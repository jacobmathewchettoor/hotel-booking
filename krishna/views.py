...
def homepage(request):
    ...
    data = {'rooms':room,'all_location':all_location}
...
def book_room(request):
    ...
    if request.method =="POST":
        ...
        reservation.fname = request.POST['fname']
        reservation.lname = request.POST['lname']
        reservation.mobile = request.POST['mobile']
        ...
        print(num_days)
        total=room_object.price * num_days
...
def cancel(request,pk):
    ...
    b.delete()
    return redirect("http://127.0.0.1:8000/user/bookings")
